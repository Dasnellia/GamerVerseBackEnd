...
// Middleware de autenticación de administrador, exportado directamente
...
export const getAllNoticias: RequestHandler = async (req: Request, res: Response) => {
  try {
...
export const getNoticiaById: RequestHandler = async (req: Request, res: Response) => {
...
export const crearNoticia: RequestHandler = async (req: AuthenticatedRequest, res: Response) => {
...
export const editarNoticia: RequestHandler = async (req: AuthenticatedRequest, res: Response) => {
  const noticiaID = parseInt(req.params.id);
  const { Titulo, Descripcion, Foto } = req.body;
...
export const borrarNoticia: RequestHandler = async (req: AuthenticatedRequest, res: Response) => {
  const noticiaID = parseInt(req.params.id);
